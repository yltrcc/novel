...
package com.ttxxly.reader.manager;


import com.ttxxly.reader.entity.Const;
import com.ttxxly.reader.utils.ScreenUtils;
import com.ttxxly.reader.utils.SharedPreferencesUtil;
...
public class SettingManager {
    ...
    public int getReadTheme() {
        if (SharedPreferencesUtil.getInstance().getBoolean(Const.ISNIGHT, false)) {
    ...
    public String getUserChooseSex() {
        return SharedPreferencesUtil.getInstance().getString("userChooseSex", Const.MALE);
    }
